...
public class PdsController {
	...
	public String regist(PdsRegistCommand registReq, RedirectAttributes rttr, HttpServletRequest request) 
																	throws Exception {
	...
	public String modifyPOST(PdsModifyCommand modifyReq,RedirectAttributes rttr, HttpServletRequest request) throws Exception {
